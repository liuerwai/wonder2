...
function(e) {
    ...
    t.all = function(e, t) {
        var i, s = [];
        return (i = t ? t.querySelectorAll(e) : document.querySelectorAll(e)) && i.length > 0 && (s = Array.prototype.slice.call(i)),
        s
    },
    t.delegate = function(e, i, s, a) {
        e && e.addEventListener(i,
        function(i) {
            var n = t.all(s, e);
    ...
    var i = function() {
        this.winw = e.innerWidth || document.body.clientWidth,
        this.winh = e.innerHeight || document.body.clientHeight,
        this.originWinw = this.winw,
        this.originWinh = this.winh,
        this.marginRight = 15,
        this.imageChageMoveX = this.marginRight + this.winw,
        this.imageChageNeedX = Math.floor(.5 * this.winw),
        ...
        this.openTime = .3,
        this.slipTime = .5,
        this.maxOverWidthPercent = .5,
        this.$box = !1,
        this.isPreview = !1;
        var t = document.createElement("style");
        t.innerText = "#__previewImage-container{-ms-touch-action:none;touch-action:none;-webkit-touch-action:none;line-height:100vh;background-color:#000;width:100vw;height:100vh;position:fixed;overflow:hidden;top:0;left:0;z-index: 2147483647;transition:transform .3s;-ms-transition:transform .3s;-moz-transition:transform .3s;-webkit-transition:transform .3s;-o-transition:transform .3s;transform:translate3d(100%,0,0);-webkit-transform:translate3d(100%,0,0);-ms-transform:translate3d(100%,0,0);-o-transform:translate3d(100%,0,0);-moz-transform:translate3d(100%,0,0)}#__previewImage-container .previewImage-text{position:absolute;top:.6em;text-align:center;font-size:16px;line-height:22px;color:#fff;z-index:10;padding: 0.2em 0.4em;background-color: rgba(255,255,255,0.4);border-radius: 50%;letter-spacing: 0;right:.8em}#__previewImage-container .previewImage-text .previewImage-text-index{font-size: 20px;}#__previewImage-container .previewImage-box{width:999999rem;height:100vh}#__previewImage-container .previewImage-box .previewImage-item{width:100vw;height:100vh;margin-right:15px;float:left;text-align:center;background:url(http://static.luyanghui.com/svg/oval.svg) no-repeat center/auto;}#__previewImage-container .previewImage-box .previewImage-item::after{content: '';height: 100%;display: inline-block;vertical-align: middle;}#__previewImage-container .previewImage-box .previewImage-item.previewImage-nobackground{background:none}#__previewImage-container .previewImage-box .previewImage-item .previewImage-image{vertical-align:middle;max-width:100%;vertical-align: middle;}",
        t.type = "text/css",
    ...
    return i.prototype.start = function(e) {
        ...
        if (s) {
            var a = i.indexOf(s);
            a < 0 && (a = 0, console.warn("current isnot on urls,it will be the first value of urls!")),
            this.index = a
        } else this.index = 0,
        console.warn("current is empty,it will be the first value of urls!");
        this.urls = i,
        this.maxLen = i.length - 1,
    ...
    i.prototype.render = function() {
        ...
        this.container = this.imgStatusCache[this.cIndex] = {
            elem: this.$container,
            x: this.winw,
            y: 0,
            m: 0,
        ...
        this.urls.forEach(function(i, s) {
            ...
            s == t.index && (a.src = i, a.onload = function() {
                n.className += " previewImage-nobackground",
                t.imgLoadCache[h].isload = !0
            })),
            t.imgStatusCache[s] = {
                hash: h,
                x: 0,
        ...
        setTimeout(function() {
            t.translateScale(t.bIndex, 0),
            t.translateScale(t.cIndex, t.openTime),
            t.isPreview = !0
        },
        50)
    },
    i.prototype.bind = function() {
        ...
        t.delegate(i, "click", ".previewImage-item",
        function() {
            s.closePreview.call(s)
        }),
        t.delegate(i, "touchstart", ".previewImage-item",
        function() {
            s.touchStartFun.call(s)
        }),
        t.delegate(i, "touchmove", ".previewImage-item",
        function() {
            s.touchMoveFun.call(s)
        }),
        t.delegate(i, "touchend", ".previewImage-item", a),
        t.delegate(i, "touchcancel", ".previewImage-item", a)
    },
    ...
    i.prototype.moveAction = function(e, t) {
        if (this.allowMove) {
            ...
            if (a <= 0 && (this.allowX = -l), n <= 0 && (this.allowY = r.y1), 1 == t.length) if (i.scale > 1) {
                ...
                i.my = n;
                if (a < 0 && i.x <= -l) this.statusX = 1,
                this.box.m = a,
                this.index == this.maxLen && (this.box.m = this.getSlowlyNum(a)),
                this.translateScale(this.bIndex, 0),
                this.translateScale(this.index, 0);
                else if (a > 0 && i.x >= l) this.statusX = 2,
                this.box.m = a,
                0 == this.index && (this.box.m = this.getSlowlyNum(a)),
                this.translateScale(this.bIndex, 0),
                this.translateScale(this.index, 0);
                else {
                    if (0 == a) return;
                ...
                if (n > 0 && o > 0) this.statusX = 7,
                this.allowY = 0,
                i.my = -i.y + this.getSlowlyNum(o, s);
                else if (n < 0 && o < -d) if (this.statusX = 7, m.height > this.winh) {
                    var g = o + d;
                    this.allowY = -d,
                    i.my = -d - i.y + this.getSlowlyNum(g, s)
                } else this.allowY = 0,
                i.my = -i.y + this.getSlowlyNum(o, s);
                else this.statusX = 6,
                i.my = n;
                ...
                this.statusX = 5,
                0 == this.index && a > 0 || this.index == this.maxLen && a < 0 ? this.box.m = this.getSlowlyNum(a) : this.box.m = a,
                this.translateScale(this.bIndex, 0)
            } else {
    ...
    i.prototype.endAction = function(e, t) {
        ...
        if (this.allowMove = !1, 1 == e.length) {
            ...
            case 3:
                i.x = i.x + i.m,
                i.m = 0,
                this.translateScale(this.index, n);
                break;
            case 4:
                i.x = this.allowX,
                i.m = 0,
            ...
            i.x > r.x ? (n = this.slipTime, i.x = r.x) : i.x < -r.x && (n = this.slipTime, i.x = -r.x),
            i.y > r.y0 ? (n = this.slipTime, i.y = r.y0) : i.y < r.y1 && (n = this.slipTime, i.y = r.y1),
            o.height * i.scale <= this.winh && (i.y = 0),
            o.width * i.scale <= this.winw && (i.x = 0),
            i.scalem = 1,
            h > this.maxScale ? (i.scale = this.maxScale, n = this.slipTime) : h < 1 && (this.imgStatusRewrite(), n = this.slipTime),
            0 != n && (this.changeIndex(0), this.translateScale(this.index, n))
        }
    },
    ...
    i.prototype.imgStatusRewrite = function(e) {
        ...
        t.scale = 1,
        t.scalem = 1,
        e != this.index && this.translateScale(e, this.slipTime)
    },
    i.prototype.changeIndex = function(e) {
        ...
        if (0 == this.index && -1 == e) this.index = this.index;
            ...
            s.isload ? s.elem.parentNode.className += " previewImage-nobackground": (s.elem.src = this.urls[this.index], s.elem.onload = function() {
                s.elem.parentNode.className += " previewImage-nobackground",
                s.isload = !0
            })
        }
        this.box.x = -this.imageChageMoveX * this.index,
        this.box.m = 0,
        t != this.index && this.imgStatusRewrite(t),
    ...
    i.prototype.translateScale = function(e, t) {
        ...
        this.addCssPrefix($elem, "transition", n),
        this.addCssPrefix($elem, "transform", a)
    },
    ...
    i.prototype.getTouches = function(e) {
        ...
        return i.x0 = t[0].pageX,
        i.y0 = t[0].pageY,
        i.time = (new Date).getTime(),
        t.length >= 2 && (i.x1 = t[0].pageX, i.y1 = t[1].pageY),
        i
    },
    e.previewImage = new i,
